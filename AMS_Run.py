...
import time
import pymysql
Face_reco_fill = 'face_reco_fill'
manually_fill_attendance='manually_fill_attendance'
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='123456', db='manually_fill_attendance')
            cursor = connection.cursor()
        except Exception as e:
            print(e)

        sql = "Attand " + manually_fill_attendance + """
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:\\Users\\welcome\\Desktop\\face\\Face-Recognition-Attendance-System-main\\Attendance\\Manually Attendance+'.csv 
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='12345', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)

                sql = "CREATE TABLE " + Face_reco_fill + """
                (ID INT NOT NULL AUTO_INCREMENT,
                 ENROLLMENT varchar(100) NOT NULL,
                 NAME VARCHAR(50) NOT NULL,
                 DATE VARCHAR(20) NOT NULL,
